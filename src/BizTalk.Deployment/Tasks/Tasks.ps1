...
. $PSScriptRoot\..\Commands\BtsBinding\BtsBinding.ps1
. $PSScriptRoot\..\Commands\BtsResource\BtsResource.ps1
. $PSScriptRoot\..\Commands\Resource\Resource.ps1
. $PSScriptRoot\..\Commands\ResourceGroup\ResourceGroup.ps1
...
. $PSScriptRoot\Tasks.Manifest.ps1
. $PSScriptRoot\Tasks.ServiceComponents.ps1

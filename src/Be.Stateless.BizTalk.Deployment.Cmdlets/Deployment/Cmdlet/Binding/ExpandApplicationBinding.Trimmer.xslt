...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!--
      *
      * phased processing:
      *   1. clean up bindings, e.g. discard empty stages, default values, enclosed passwords/passphrases in CDATA, etc...
  ...
  <xsl:template match="@*|node()" mode="trimming-one">
    <xsl:copy>
      <xsl:apply-templates select="@*" mode="trimming-one" >
        <!-- uncomment the following line should you not want to sort the attributes -->

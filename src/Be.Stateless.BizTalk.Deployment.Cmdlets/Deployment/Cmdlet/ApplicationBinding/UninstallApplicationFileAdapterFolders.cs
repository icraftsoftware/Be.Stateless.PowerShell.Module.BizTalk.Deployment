...
namespace Be.Stateless.BizTalk.Deployment.Cmdlet
{
	...
	public class UninstallApplicationFileAdapterFolders : ApplicationBindingCmdlet
	{
		#region Base Class Member Overrides

		protected override void BeginProcessing()
		{
			WriteInformation("Deleting Folders for File Adapters Defined by Code-First BizTalk Application Bindings...");
		}
		...
		{
			applicationBinding.Accept(new FileAdapterFolderUninstaller(Recurse, WriteInformation));
		}

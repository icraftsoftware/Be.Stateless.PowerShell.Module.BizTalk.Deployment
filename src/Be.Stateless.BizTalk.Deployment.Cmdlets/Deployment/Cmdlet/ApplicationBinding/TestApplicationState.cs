...
namespace Be.Stateless.BizTalk.Deployment.Cmdlet
{
	...
	public class TestApplicationState : ApplicationBindingCmdlet
	{
		#region Base Class Member Overrides

		protected override void BeginProcessing()
		{
			WriteVerbose("Testing Correspondence of BizTalk Services' State to that Defined by Code-First BizTalk Application Bindings...");
		}
		...
		protected override void ProcessApplicationBinding(IVisitable<IApplicationBindingVisitor> applicationBinding)
		{
			try
			{
				applicationBinding.Accept(new BizTalkServiceStateValidator());
				WriteObject(true);
			}
